...
app/
  ...
  Views/cmsadmin/     ✅ layouts/ (app, auth) · partials/ (head, navbar, sidebar, footer, scripts, flash, page-header, status-badge, pagination, empty-state) · pages/ (dashboard, properties, auth, account, geo, catalog/{categories,attributes,features}, sites, errors) · partials auth-aside, password-field, field, switch, state-badge, row-actions
  ...
  Controllers/        ✅ Controller (base) · Front/HomeController (503 « en préparation » jusqu’au lot 1.8) · Cmsadmin/ (Controller de base, Auth, Password, Account, Site, Geo/{City,Commune,District}, Catalog/{Category,Attribute,Feature}) · Preview/ (PROVISOIRE, maquettes)
                      ⬜ Front (Search, Property, Agency, Page, Lead…) + Cmsadmin/ (Dashboard, Properties, Agencies, Leads, Users, Seo, Settings…)
  ...
  Services/           ✅ SiteRepository, Settings, CountryRepository, GeoRepository, CatalogRepository · Auth, UserRepository, PasswordHasher, PasswordReset, LoginThrottle, RateLimiter, ActivityLogger, Mailer, IpAddress · ⬜
bin/
