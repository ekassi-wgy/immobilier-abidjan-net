...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces · 1.7 espace agence · 1.8 accueil · 1.9 page de résultats · 1.10 fiche annonce · 1.11 annuaire des agences, pages éditoriales, formulaires publics · 1.12 tableau de bord de l'équipe, exports CSV, Paramètres · 1.13 recette par rôle. **La phase 1 (MVP Côte d'Ivoire) est terminée.** Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 2.1 — SEO** : méta par page pilotées depuis le back-office (table `seo_meta`), `sitemap.xml` dynamique (accueil, résultats indexables, annonces publiées, agences actives, pages publiées), `robots.txt`, redirections 301 gérées en base (table `redirects`), vérification des canoniques et des données structurées déjà posées aux lots 1.8 à 1.11. Le menu déclare déjà `/cmsadmin/seo` et `/cmsadmin/seo/redirections` (404 jusqu'à ce lot).
...
app/
  ...
  Views/cmsadmin/     ✅ layouts/ (app, auth) · partials/ (head, navbar, sidebar, footer, scripts, flash, page-header, status-badge, pagination, empty-state, auth-aside, password-field, field, switch, state-badge, row-actions) · pages/ (dashboard/{staff, agency}, properties/{index,show,form,criteria}, auth, account, geo, catalog/{categories,attributes,features}, sites, agencies/{index,form,profile}, leads/{index,show}, users, partner-requests, exports, settings, errors)
  ...
  Controllers/        ✅ Controller (base) · Front/ (Controller socle public, HomeController lot 1.8, SearchController lot 1.9, PropertyController lot 1.10, AgencyController · ContactController · PageController lot 1.11, FavoriteController) · Cmsadmin/ (Controller de base, Dashboard, Auth, Password, Account, Site, Lead, Geo/{City,Commune,District}, Catalog/{Category,Attribute,Feature}, Agencies/{Agency,AgencyProfile,AgencyAccount,StaffUser,PartnerRequest}, Properties/{Property,PropertyAction,PropertyMedia}, Notification) · Preview/ (PROVISOIRE : page 500 seule)
