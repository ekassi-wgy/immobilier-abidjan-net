...
- **Nom public** (0012, 0013) : `sites.name` passe de « immobilier.abidjan.net » à « Abidjan.net Immobilier », puis tous les textes publics emploient ce nom — À propos, cookies et confidentialité (0013), mentions légales et CGU (0014, domaine gardé entre parenthèses pour identifier le site). Le domaine lui-même ne change pas.
