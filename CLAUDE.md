...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels (pays & sites, géographie, catalogue) · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces (formulaire dynamique, photos, carte, validation, révisions, expiration) · 1.7 espace agence (tableau de bord, profil de l'agence, demandes de contact) · 1.8 accueil du site public (hero, recherche, biens à la une, types de biens, chiffres clés, agences en vedette) · 1.9 page de résultats (filtres multicritères, tri, pagination, vues grille/liste/carte, favoris visiteurs) · 1.10 fiche annonce (galerie et visionneuse, critères, situation juridique, carte, bloc agence, demande de contact, biens similaires, partage). Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 1.11 — annuaire des agences, pages statiques et formulaires publics** (`/agences`, `/agences/{slug}`, À propos, Comment ça marche, Contact, Devenir partenaire, Déposer un bien, mentions légales, bandeau cookies). Le socle est prêt : la fiche annonce et les cartes pointent déjà vers `/agences/{slug}` (**404 jusqu'à ce lot**), `AgencyRepository` et `PartnerRequestRepository` existent, et le formulaire de contact du lot 1.10 sert de modèle (CSRF, pot de miel, `RateLimiter`, consentement, lead + notification) : réutiliser exactement le même gabarit pour les types `agency_contact`, `general_contact` et `property_submission`.
...
app/
  ...
  Views/front/        ✅ layouts/app (SEO : canonique, Open Graph, JSON-LD, feuilles et scripts par page) · partials/ (header, footer, hero, search, property-card, search-filters, pagination, property-gallery, property-contact) · pages/ (home, search, property, favorites, styleguide, errors/error)
  ...
  Controllers/        ✅ Controller (base) · Front/ (HomeController accueil lot 1.8, SearchController résultats lot 1.9, PropertyController fiche annonce lot 1.10, FavoriteController favoris) · Cmsadmin/ (Controller de base, Dashboard, Auth, Password, Account, Site, Lead, Geo/{City,Commune,District}, Catalog/{Category,Attribute,Feature}, Agencies/{Agency,AgencyProfile,AgencyAccount,StaffUser,PartnerRequest}, Properties/{Property,PropertyAction,PropertyMedia}, Notification) · Preview/ (PROVISOIRE : tableau de bord fictif de l’équipe interne)
                      ⬜ Front (Agency, Page, Lead…) + Cmsadmin/ (Dashboard, Leads, Seo, Settings…)
...
database/             ✅ schema.sql (référence v1, 38 tables) · seed.sql (référentiels CI) · migrations/ (0002 révisions, 0003 icônes des familles) — voir docs/database.md
