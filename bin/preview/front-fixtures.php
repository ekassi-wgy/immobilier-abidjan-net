...
/**
 * Données fictives du site public pour la prévisualisation (maquette d'accueil, charte graphique).
 * Photos provisoires : public/assets/img/placeholder (voir CREDITS.md). Agences inventées.
 */
...
$properties = [
    [
        ...
        'location' => 'Riviera Golf, Cocody', 'image' => $img('villa-piscine-palmiers'), 'image_alt' => 'Villa blanche avec piscine entourée de palmiers', 'photos' => 18,
    ...
    [
        ...
        'location' => 'Zone 4, Marcory', 'image' => $img('salon-contemporain'), 'image_alt' => 'Salon contemporain lumineux avec canapé en cuir', 'photos' => 12,
    ...
    [
        ...
        'location' => 'Assinie-Mafia', 'image' => $img('piscine-debordement'), 'image_alt' => 'Piscine à débordement face à la végétation au coucher du soleil', 'photos' => 24,
        'badges' => [],
    ...
    [
        ...
        'location' => 'Centre des affaires, Plateau', 'image' => $img('plateau-tour-affaires'), 'image_alt' => 'Tour de bureaux dans le quartier du Plateau', 'photos' => 9,
        'badges' => [['label' => 'À la une', 'variant' => 'featured']],
    ...
    [
        ...
        'location' => 'Angré, Cocody', 'image' => $img('villa-escalier-piscine'), 'image_alt' => 'Villa blanche avec escalier en colimaçon et piscine', 'photos' => 15,
        'badges' => [],
    ...
    [
        ...
        'location' => 'Deux-Plateaux Vallon, Cocody', 'image' => $img('cuisine-ouverte'), 'image_alt' => 'Séjour moderne avec cuisine ouverte', 'photos' => 10,
        'badges' => [['label' => 'Nouveau', 'variant' => 'new']],
...
$search = [
    ...
    'propertyTypes' => [
        ...
        ['slug' => 'villa', 'label' => 'Villa / Maison'],
        ['slug' => 'terrains', 'label' => 'Terrain'],
        ['slug' => 'bureau', 'label' => 'Bureau'],
        ['slug' => 'local-commercial', 'label' => 'Local commercial'],
        ['slug' => 'magasin-entrepot', 'label' => 'Magasin / Entrepôt'],
        ['slug' => 'residence-vacances', 'label' => 'Résidence de vacances'],
    ],
    'budgets' => [
