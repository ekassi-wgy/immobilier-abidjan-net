...
$navigation = [
    ...
    ['label' => __('front.nav.commercial'), 'url' => 'louer/commercial-bureaux'],
    ['label' => __('front.nav.agencies'), 'url' => 'agences'],
];
?>
<header class="im-header<?= $overlay ? ' im-header--overlay' : ' is-scrolled' ?>" data-header>
  <div class="im-container im-header__inner">
    ...
    <div class="im-header__actions">
      ...
      <a class="im-btn im-btn--dark im-btn--sm im-header__cta" href="<?= e(url('deposer-un-bien')) ?>"><?= e(__('front.nav.submit_property')) ?></a>
...
<div class="im-menu" id="im-menu" role="dialog" aria-modal="true" aria-label="<?= e(__('front.nav.menu_label')) ?>" data-menu hidden>
  ...
  <div class="im-container im-menu__footer">
    <a class="im-btn im-btn--dark im-btn--block" href="<?= e(url('deposer-un-bien')) ?>"><?= e(__('front.nav.submit_property')) ?></a>
