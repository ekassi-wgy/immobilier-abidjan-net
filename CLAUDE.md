...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces · 1.7 espace agence · 1.8 accueil · 1.9 page de résultats · 1.10 fiche annonce · 1.11 annuaire des agences, pages éditoriales, formulaires publics, bandeau cookies · 1.12 tableau de bord de l'équipe, exports CSV, écran Paramètres. **Le site public et le back-office sont complets ; il ne reste aucun écran à données fictives.** Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 1.13 — recette par rôle** : dérouler un scénario complet pour chaque rôle (visiteur, agence, Admin Pays, Super Admin), contrôler le rendu mobile 375 px et les navigateurs, consigner la checklist dans `docs/tests.md` (à créer) et corriger ce qui remonte. Points à couvrir en priorité : cloisonnement pays et agence sur chaque écran, workflow d'annonce de bout en bout (dépôt → validation → révision → expiration), formulaires publics (CSRF, pot de miel, quotas), emails réellement envoyés, et parcours d'une annonce depuis la recherche jusqu'au contact.
