...
- **Nom public** (0012, 0013) : `sites.name` passe de « immobilier.abidjan.net » à « Abidjan.net Immobilier », puis les pages À propos, cookies et confidentialité emploient ce nom (le domaine ne change pas et reste dans les mentions légales et les CGU).
