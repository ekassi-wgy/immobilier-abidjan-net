...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels (pays & sites, géographie, catalogue) · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces (formulaire dynamique, photos, carte, validation, révisions, expiration) · 1.7 espace agence (tableau de bord, profil de l'agence, demandes de contact) · 1.8 accueil du site public (hero, recherche, biens à la une, types de biens, chiffres clés, agences en vedette). Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 1.9 — page de résultats** (`/acheter/…`, `/louer/…` : filtres multicritères, tri, pagination, vues grille/liste/carte avec clusters, favoris en cookie). Le socle est prêt : `ListingRepository` (mêmes règles de périmètre à réutiliser), `ListingPresenter` (cartes), `SearchOptions` (transactions, types groupés, paliers de budget), partial `front/partials/property-card` en variante `row`, Leaflet auto-hébergé. **L'accueil pointe déjà vers ces URL : elles répondent 404 jusqu'à ce lot.**
...
app/
  ...
  Views/front/        ✅ layouts/app (SEO : canonique, Open Graph, JSON-LD) · partials/ (header, footer, hero, search, property-card) · pages/ (home, styleguide, errors/error)
  ...
  Controllers/        ✅ Controller (base) · Front/HomeController (accueil réel, lot 1.8) · Cmsadmin/ (Controller de base, Dashboard, Auth, Password, Account, Site, Lead, Geo/{City,Commune,District}, Catalog/{Category,Attribute,Feature}, Agencies/{Agency,AgencyProfile,AgencyAccount,StaffUser,PartnerRequest}, Properties/{Property,PropertyAction,PropertyMedia}, Notification) · Preview/ (PROVISOIRE : tableau de bord fictif de l’équipe interne)
