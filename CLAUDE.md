...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels (pays & sites, géographie, catalogue) · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces (formulaire dynamique, photos, carte, validation, révisions, expiration). Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 1.7 — espace agence** (tableau de bord de l'agence : ses annonces par statut et statistiques, profil de l'agence modifiable par le responsable — logo, description, coordonnées, zones —, contacts reçus). Le socle est prêt : `AgencyRepository`, `PropertyRepository::countsByStatus($pays, $agenceId)`, `Notifier`, menu `agency_profile` déjà déclaré dans `config/cmsadmin-menu.php`.
...
app/
  ...
  Views/cmsadmin/     ✅ layouts/ (app, auth) · partials/ (head, navbar, sidebar, footer, scripts, flash, page-header, status-badge, pagination, empty-state, auth-aside, password-field, field, switch, state-badge, row-actions) · pages/ (dashboard, properties/{index,show,form,criteria}, auth, account, geo, catalog/{categories,attributes,features}, sites, agencies, users, partner-requests, errors)
  ...
  Controllers/        ✅ Controller (base) · Front/HomeController (503 « en préparation » jusqu’au lot 1.8) · Cmsadmin/ (Controller de base, Auth, Password, Account, Site, Geo/{City,Commune,District}, Catalog/{Category,Attribute,Feature}, Agencies/{Agency,AgencyAccount,StaffUser,PartnerRequest}, Properties/{Property,PropertyAction,PropertyMedia}, Notification) · Preview/ (PROVISOIRE : tableau de bord fictif)
