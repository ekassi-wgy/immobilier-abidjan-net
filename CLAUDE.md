...
- **Terminés** : 0.1 cadrage · 0.2 schéma BDD · 0.3 charte graphique · 0.4 back-office StarAdmin rethémé · 1.1 socle applicatif · 1.2 multisite · 1.3 authentification · 1.4 référentiels (pays & sites, géographie, catalogue) · 1.5 agences, comptes, demandes de partenariat · 1.6 module annonces (formulaire dynamique, photos, carte, validation, révisions, expiration) · 1.7 espace agence (tableau de bord, profil de l'agence, demandes de contact) · 1.8 accueil du site public · 1.9 page de résultats (filtres multicritères, tri, pagination, vues grille/liste/carte, favoris visiteurs) · 1.10 fiche annonce (galerie et visionneuse, critères, situation juridique, carte, bloc agence, demande de contact, biens similaires, partage) · 1.11 annuaire et profil des agences, pages éditoriales, formulaires Contact / Devenir partenaire / Déposer un bien, bandeau cookies. **Le site public est complet.** Détail et livrables : `docs/PLAN.md`.
- **Prochain lot : 1.12 — tableau de bord et exports du back-office** (statistiques annonces / vues / contacts / top biens, exports CSV des annonces et des contacts, paramètres de commission). Le socle est prêt : `StatsRepository` (audience, top biens, à corriger, expirations) alimente déjà le tableau de bord agence du lot 1.7, `property_stats_daily` est renseignée par le site public depuis le lot 1.10 (vues et contacts), Chart.js est chargé via `$plugins = ['chart']`. **`pages/dashboard/index.php` est encore la maquette fictive de `Preview/` : ce lot la remplace et retire `bin/preview/fixtures.php`.** Le taux de commission reste une décision client en attente.
