...
Les quatre **mentions obligatoires** manquantes des mentions légales (forme juridique, capital, RCCM,
directeur de publication, hébergeur) doivent aussi être complétées dans `/cmsadmin/pages` avant
